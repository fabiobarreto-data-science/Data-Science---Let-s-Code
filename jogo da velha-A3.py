...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 1:
        tabuleiro["A"][0] = "X"
    if jogada == 2 and tabuleiro["A"][2] == "O":tabuleiro["C"][0] = "X" # A3
    ...
    elif (jogada == 5 and tabuleiro["A"][1] == "O") and (tabuleiro["C"][2] == "O") and (tabuleiro["B"][0] == "O") and (tabuleiro["A"][2] == "O"):tabuleiro["B"][2] = "X" # A3
