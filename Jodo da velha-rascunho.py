...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 1:
        tabuleiro["A"][0] = "X"
        """ Caminho 01"""
    if jogada == 2 and tabuleiro["B"][1] != "O":
        if tabuleiro["C"][2] == "O":
            tabuleiro["A"][2] = "X"
        else:
            if tabuleiro["A"][1] == "O":
                ...
                if tabuleiro["B"][0] == "O":
                    ...
                    if tabuleiro["B"][1] == "O":
                        tabuleiro["A"][2] = "X"
                    if jogada == 3 and tabuleiro["A"][1] == "O":
                        tabuleiro["B"][1] = "X"
                    else:
                        if jogada == 3 and tabuleiro["C"][2] == "O":
                            tabuleiro["C"][1] = "X"
                        if jogada == 4 and tabuleiro["A"][1] == "O":
                            tabuleiro["C"][0] = "X"
                        else:
                            if jogada == 5 and tabuleiro["B"][0] == "O":
                                tabuleiro["A"][2] = "X"
    ...
    if jogada == 2 and tabuleiro["B"][1] == "O":
        ...
        if jogada == 3 and tabuleiro["A"][1] == "O":
            ...
            if (jogada == 4 and tabuleiro["B"][0] == "O") or (jogada == 4 and tabuleiro["C"][0] == "O") or (jogada == 4 and tabuleiro["C"][2] == "O") or (jogada == 4 and tabuleiro["B"][2] == "O"):
                if tabuleiro["B"][0] == "O":
                    tabuleiro["B"][2] = "X"
                else:
                    if tabuleiro["B"][2] == "O":
                ...
                if (jogada == 5 and tabuleiro["C"][2] == "O") or (jogada == 5 and tabuleiro["C"][0] == "O") or (jogada == 5 and tabuleiro["B"][2] == "O") or (jogada == 5 and tabuleiro["B"][0] == "O"):
                    if tabuleiro["C"][2] == "O":
                        tabuleiro["C"][0] = "X"
                    else:
                        if tabuleiro["C"][0] == "O":
