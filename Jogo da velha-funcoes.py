...
from Jogada_valida import jogada02, jogada03, jogada04, jogada05
...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 1:
        tabuleiro["A"][0] = "X"
    elif jogada == 2:jogada02(tabuleiro, jogada)
    elif jogada == 3:jogada03(tabuleiro, jogada)
    elif jogada == 4:jogada04(tabuleiro, jogada)
    elif jogada == 5:jogada05(tabuleiro, jogada)
