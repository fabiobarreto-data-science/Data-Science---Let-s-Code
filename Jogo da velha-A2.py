...
def jogadaMaquina(tabuleiro, jogada):
    ...
    Retorno: tabuleiro
    """
    if jogada == 1:tabuleiro["A"][0] = "X"  # A2
    if jogada == 2 and tabuleiro["A"][1] == "O":tabuleiro["B"][1] = "X"  # A2
    elif (jogada == 3 and tabuleiro["C"][2] == "O") and (tabuleiro["A"][1] == "O"):tabuleiro["B"][0] = "X"  # A2
    elif (jogada == 4 and tabuleiro["C"][0] == "O") and (tabuleiro["C"][2] == "O") and (tabuleiro["A"][1] == "O"):tabuleiro["B"][2] = "X"  # A2
